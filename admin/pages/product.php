                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <form action="" method="get">
                                <a href="productadd.php"><button type="button" class="btn btn-success" style="float: right; margin-top:-32px">
                            </form>
                                    ...
                                    <div class="table-responsive" style="margin-top: 2%">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php
                                                            echo $textSh = $fm->textShorten($result['mieuTaSanPham'], 80); //Giới hạn kí tự để hiển thị
                                                        ?>    
                                                    </td>
                                                    <td class="center">
                                                    <?php 
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="?hideid=<?php echo $result['maSanPham'] ?>" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')"><button type="button" class="btn btn-warning " >Xóa</button></a>
                                                    </td>
                                                </tr>
                                                <?php 
                                                        }
                                        ...
                                        <div class="phanTrang">
                                            <?php 
                                                    ...
                                                    $productButton = ceil($productCount/5); //Số button phân trang sẽ hiển thị, 10 sản phẩm thì chia 10
