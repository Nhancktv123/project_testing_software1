                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="chitietdonhang.php?maDonHang=<?php echo $resultDH['maDonHang'] ?>" ><button type="button" class="btn btn-info" id="btnShow" >Xem chi tiết</button>
                                                            </a>
                                                        
                                                        <?php 
                                                            $maDH = $resultDH['maDonHang'];
                                                            if ($resultDH['trangThaiDH'] == "Chưa giao"){
                                                                echo "<a href='?statusid=$maDH'><button type='button' class='btn btn-success'>Xác nhận đơn hàng</button></a>";
                                                            }
                                                        ?>
